get_filename_component(_PRECOMPILE_DIR "${CMAKE_CURRENT_LIST_DIR}" DIRECTORY)
get_filename_component(_ENGINE_DIR "${_PRECOMPILE_DIR}" DIRECTORY)
set(PRECOMPILE_TOOLS_PATH "${_ENGINE_DIR}/bin")
