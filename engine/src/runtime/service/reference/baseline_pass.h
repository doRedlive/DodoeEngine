...
namespace dodoe {
    ...
    struct BaselineRenderTargets {
        ...
        GfxTextureHandle gbuffer_motion{};
        ...
        // TAA
        GfxTextureHandle taa_history_a{};
        GfxTextureHandle taa_history_b{};
        GfxFramebufferHandle taa_framebuffer_a{};
        GfxFramebufferHandle taa_framebuffer_b{};
