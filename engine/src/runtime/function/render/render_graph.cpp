...
namespace dodoe {
	...
	void RenderGraph::setup() {
		...
		main_camera_depth_desc.shader_resource = false;
		...
		addPass("MainCameraPass", create_ref<MainCameraPass>(m_rhi, m_camera, m_descriptor_manager))
			.addTextureWrite("MainCameraColor", main_camera_color_desc)
			.addTextureWrite("MainCameraDepth", main_camera_depth_desc);

		addPass("SpritePass", create_ref<SpritePass>(m_rhi, m_camera, m_descriptor_manager))
			.addTextureWrite("MainCameraColor", main_camera_color_desc)
			.addTextureWrite("MainCameraDepth", main_camera_depth_desc);
