...
namespace dodoe {
    ...
    class Texture : public Object {
        ...
        Int32 m_height{0};
        String m_path{};
        gfx::TextureHandle m_gpu_handle{};
    ...
    public:
        ...
        [[nodiscard]] gfx::TextureHandle getGpuHandle() const { return m_gpu_handle; }
        ...
        void setGpuHandle(const gfx::TextureHandle handle) { m_gpu_handle = handle; }
