...
namespace dodoe {
	class ColorGradingPass : public RenderPass {
		inline static const std::string kInputColorResourceName = "MainCameraToneMappedColor";
		inline static const std::string kOutputColorResourceName = "MainCameraColor";
	...
	public:
		explicit ColorGradingPass(RhiContext* rhi) { m_rhi = rhi; }
