...
namespace dodoe {
    ...
    Bool PrefabAsset::loadFromSource(const String& absolute_source_path) {
    ...
    void PrefabAsset::unloadRuntime() {
        m_scene_res = SceneRes{};
    }

    Bool PrefabAsset::saveToSource(const String& absolute_path) const {
