...
// === GENERATED BINDINGS START (do not edit manually) ===
        ...
        public delegate* unmanaged<ulong, int> native_AudioSourceComponent_clip_get;
        public delegate* unmanaged<ulong, int, void> native_AudioSourceComponent_clip_set;
        public delegate* unmanaged<ulong, float> native_AudioSourceComponent_volume_get;
        public delegate* unmanaged<ulong, float, void> native_AudioSourceComponent_volume_set;
        public delegate* unmanaged<ulong, float> native_AudioSourceComponent_pitch_get;
        public delegate* unmanaged<ulong, float, void> native_AudioSourceComponent_pitch_set;
        public delegate* unmanaged<ulong, bool> native_AudioSourceComponent_loop_get;
        public delegate* unmanaged<ulong, bool, void> native_AudioSourceComponent_loop_set;
        public delegate* unmanaged<ulong, bool> native_AudioSourceComponent_play_on_awake_get;
        public delegate* unmanaged<ulong, bool, void> native_AudioSourceComponent_play_on_awake_set;
        public delegate* unmanaged<ulong, float> native_AudioSourceComponent_spatial_blend_get;
        public delegate* unmanaged<ulong, float, void> native_AudioSourceComponent_spatial_blend_set;
        ...
        public delegate* unmanaged<ulong, float*, float*, float*, float*, void> native_DirectionalLightComponent_color_get;
        public delegate* unmanaged<ulong, float, float, float, float, void> native_DirectionalLightComponent_color_set;
        public delegate* unmanaged<ulong, float> native_DirectionalLightComponent_intensity_get;
        public delegate* unmanaged<ulong, float, void> native_DirectionalLightComponent_intensity_set;
