...
// === GENERATED BINDINGS START (do not edit manually) ===
        ...
        public delegate* unmanaged<ulong, float> native_Camera2dComponent_zoom_get;
        public delegate* unmanaged<ulong, float, void> native_Camera2dComponent_zoom_set;
        public delegate* unmanaged<ulong, float> native_Camera2dComponent_fov_get;
        public delegate* unmanaged<ulong, float, void> native_Camera2dComponent_fov_set;
        public delegate* unmanaged<ulong, float> native_Camera2dComponent_near_plane_get;
        public delegate* unmanaged<ulong, float, void> native_Camera2dComponent_near_plane_set;
        public delegate* unmanaged<ulong, float> native_Camera2dComponent_far_plane_get;
        public delegate* unmanaged<ulong, float, void> native_Camera2dComponent_far_plane_set;
        public delegate* unmanaged<ulong, float> native_Camera2dComponent_aspect_ratio_get;
        public delegate* unmanaged<ulong, float, void> native_Camera2dComponent_aspect_ratio_set;
        public delegate* unmanaged<ulong, float*, float*, float*, float*, void> native_Camera2dComponent_background_get;
        public delegate* unmanaged<ulong, float, float, float, float, void> native_Camera2dComponent_background_set;
